...
@section('content')
    <div class="bg-warning cover-container d-flex w-100 p-3 mx-auto flex-column">
        <main class="px-auto container">
            <div class="p-4 mt-4 text-center">
                <h1 class="main-title">Scopri il nostro catalogo</h1>
                <p class="lead">500+ articoli</p>
            </div>
        </main>
    </div>
        ...
        <div class="container">
            <div class="row mb-2 d-flex justify-content-center">
                ...
                <div class="col-md-6 mt-4">
                    <div class="record-card-container bg-light row g-0 border border-secondary rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
